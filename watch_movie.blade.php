...
@section('css')
    <style>
        ...
        #ad_video::-webkit-media-controls-play-button {}

        #ad_video::-webkit-media-controls-volume-slider {}

        #ad_video::-webkit-media-controls-mute-button {}

        #ad_video::-webkit-media-controls-timeline {}

        #ad_video::-webkit-media-controls-current-time-display {} */
...
@section('content')
  ...
  z-index: 0;" id="video" controlsList="nodownload" oncontextmenu="return false;">
                ...
                <video style="margin: 0; padding: 0;" id="ad_video" controls controlsList="nodownload" oncontextmenu="return false;">
